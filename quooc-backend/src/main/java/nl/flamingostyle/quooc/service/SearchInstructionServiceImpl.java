...
public class SearchInstructionServiceImpl implements SearchInstructionService {
    ...
    public List<SearchInstruction> getAll() {
        ...
        Query query = getCurrentSession().createQuery("FROM  SearchInstruction searchInstruction order by searchInstruction.id");
    ...
    public SearchInstruction get(Integer id) {
        ...
        SearchInstruction searchInstruction = (SearchInstruction) getCurrentSession().get(SearchInstruction.class, id);
        logger.debug("Gotten searchInstruction " + searchInstruction.getArgument());
